...
export default function PartnerMentalHealthGuide({ darkMode, onToggleTheme, language = "en", onLanguageChange = () => {}, activeSection = 0, embedded = false, onSectionLabelsChange }){
