...
const DARK = {
  bg:"#080d1a", card:"#0f1628", cardAlt:"#111827",
  border:"rgba(148,163,184,0.1)", borderMed:"rgba(148,163,184,0.2)",
  text:"#f1f5f9", muted:"#e2e8f0", faint:"rgba(226,232,240,0.55)",
  accent:"#f59e0b", teal:"#22d3ee", purple:"#a78bfa",
  gold:"#fbbf24", green:"#34d399", red:"#f87171",
  orange:"#fb923c", blue:"#60a5fa", pink:"#e879f9",
  navBg:"rgba(8,13,26,0.96)", shadow:"0 4px 24px rgba(0,0,0,0.4)",
  inputBg:"rgba(255,255,255,0.06)", toggleBg:"rgba(255,255,255,0.08)",
};
const LIGHT = {
  bg:"#f4f6fb", card:"#ffffff", cardAlt:"#f8fafc",
  border:"rgba(15,22,40,0.1)", borderMed:"rgba(15,22,40,0.18)",
  text:"#0f1628", muted:"#1e293b", faint:"rgba(30,41,59,0.5)",
  accent:"#d97706", teal:"#0891b2", purple:"#7c3aed",
  gold:"#d97706", green:"#059669", red:"#dc2626",
  orange:"#ea580c", blue:"#2563eb", pink:"#c026d3",
  navBg:"rgba(244,246,251,0.97)", shadow:"0 4px 24px rgba(15,22,40,0.1)",
  inputBg:"rgba(15,22,40,0.04)", toggleBg:"rgba(15,22,40,0.06)",
};
