...
export default function PartnerCommunicationGuide({ darkMode, onToggleTheme, language = "en", onLanguageChange = () => {}, activeSection = 0, embedded = false, onSectionLabelsChange }){
