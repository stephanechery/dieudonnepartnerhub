...
test("committed catalogs cover critical navigation and safety text", () => {
  ...
  "Typing searches on this device. Ask Partner Hub sends only approved topic labels and complete public learning statements to the secure model, not your raw question.",
      ...
      "Remove names or contact details, then ask again.",
      "Too many questions right now. Please wait and try again.",
      ...
      "Continue learning",
      "View Training",
      "Connect with hands-on birth or recovery support when your family needs more help.",
